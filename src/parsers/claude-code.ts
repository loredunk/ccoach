...
// These are Claude-internal structural tags/sentinels that legitimate user prose would never contain,
// so matching them as noise is an accepted, negligible-risk trade-off.
